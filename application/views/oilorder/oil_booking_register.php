...
?>
  <div class="p-2 bg-success  text-white rounded col-12">
	รายการขอเบิกน้ำมันเชื้อเพลิง
  </div>

		<form class="col-md-12" method="POST" action="<?php echo site_url('/oilorder/oilbookingadd');?>">
		  <div class="form-group">
			...
			<label> ขออนุญาตเบิกน้ำมันเชื้อเพลิง </label>
		  ...
		  <div class="form-row ">
			...
			<div class="form-group col">
				...
				<select class="form-control" name="oil_order_manager1_approve" >
		  		...
		  		<div class="form-group col-md alert-success">
