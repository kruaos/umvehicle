...
// }
	// print_r($car_order_show_by_orderid);

foreach ($car_order_show_by_orderid as $cror){
	$car_order_id=$cror->car_order_id;
	$car_order_car_number=$cror->car_order_car_number;
	$car_order_target=$cror->car_order_target;
	$car_order_detail=$cror->car_order_detail;
	$car_order_seat=$cror->car_order_seat;
	$car_order_allow1=$cror->car_order_allow1;
	$car_order_timeuse=$cror->car_order_timeuse;
	$car_order_timeback=$cror->car_order_timeback;
...
?>
		<div class="alert alert-primary col" role="alert">
			<h4>ใบขออนุญาตใช้รถส่วนกลาง แบบ3</h4>

		</div>

		<form class="col-md-12" method="POST" action="<?php echo site_url('/carorder/carorderupdate');?>">
