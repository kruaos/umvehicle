...
<div class="container col" >
  <div class="row" >
    <div class="p-2 bg-success  text-white  col-12">
      <h4>บันทึกประวัติการอนุญาตใช้รถส่วนกลาง</h4>
    </div>
  <div class="col ">
  <table class="table table-hover small table-sm">
    <thead>
      <tr>
        ...
        <th width='100' class="d-print-none">บันทึก </th>
...
?>
      ...
      <td>
        ...
        <div class="col btn-group  btn-group-toggle" >
          <a class="col btn btn-info btn-sm <?php if($car_order_allow2<>0){echo "disabled"; } ?>" href="<?php echo site_url('approvaled/carapproval_accept/'.$car_order_id);?>">อนุมัติ</a>
          <?php 
          ...
          <a class="col btn btn-danger  btn-sm" href='<?php echo site_url('approvaled/carunapproval/'.$car_order_id);?>'>ยกเลิก</a>
          <?php 
            }
          ?>
        </div>
