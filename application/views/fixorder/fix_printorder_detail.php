...
<div class="container"  >
  <div class="row" >
    <div class="p-2 bg-info col-12 ">
      พิมพ์ใบขออนุญาต การขออนุมัติซ่อม
    </div>
  <div class="col ">
  <table class="table  table-hover small table-sm">
    <thead>
      <tr>
        ...
        <th width='300' class='text-center'>สถานะ</th>
...
?>     
        ...
        <div class="col btn-group  btn-group-toggle" >
          <a class="col btn btn-primary btn-sm" href="<?php echo site_url('carorder/carorderdetail/'.$car_order_id);?>">รายละเอียด</a>
          <?php 
