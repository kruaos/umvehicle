      ...
      <?php 
          ...
          <td>
            <div class="btn btn-group  col-12 ">
              <a href="<?php echo site_url('report/printcarorder/').$car_order_id ;?>" class="btn btn-primary btn-sm">รายละเอียด</a>
              <a href="<?php echo site_url('carorder/carorderedit/').$car_order_id ;?>" class="btn btn-warning btn-sm <?php if ($car_order_allow2<>0){echo 'd-none';}?>">แก้ไข</a>
              <a href="<?php echo site_url('carorder/carordercancel/').$car_order_id ;?>" class="btn btn-danger btn-sm <?php if ($car_order_allow2<>0){echo 'd-none';}?>">ยกเลิก</a>
            </div>
          </td> 
          </tr>
          <?php 
