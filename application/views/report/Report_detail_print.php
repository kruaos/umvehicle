...
<div class="container col-10 "  style="font-family: 'Sarabun', sans-serif; font-Size:14pt">
  <div class="row">
        ...
        ?>   
          <!-- <a id="non-printable" class="btn btn-danger btn-sm col " href='<?php echo site_url('report/printorder');?>'>ย้อนกลับ</a> -->
...
<table   width='100%'>
      <tr >
        <td >&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
        &nbsp;ด้วยฝ่าย <?php echo dott(5);?><?=$fullnamecus;?><?php echo dott(5);?> กอง <?php echo dott(20);?> มีความประสงค์ต้องใช้พัสดุเพื่อ
...
<table  width='100%'>
      <tr >
        <td width='40%'></td>
        <td ><?php echo dott(22);?>เจ้าหน้าที่พัสดุ<br>
...
<table   width='100%'>
      <tr >
        <td  width='40%'></td>
        <td ><?php echo dott(22);?>ผู้ขอเบิก<br>(<?php echo $fullnamecus;?>)<br>
