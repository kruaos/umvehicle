...
<table   width='100%'>
      <tr >
        <td style="font-family: 'Sarabun', sans-serif; font-Size:14pt">&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;ด้วยฝ่าย <?php echo dott(5);?><?=$fullnamecus;?><?php echo dott(5);?> กอง <?php echo dott(40);?> มีความประสงค์ต้องใช้พัสดุเพื่อ
